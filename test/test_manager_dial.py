...
response = manager.originate('Local/1001@pytest', 9999, application='Milliwatt')
#response = manager.originate('Local/1000@pytest', 9999, application='AGI', data='test/agi01.py')
